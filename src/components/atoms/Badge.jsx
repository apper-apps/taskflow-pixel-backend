...
const Badge = forwardRef(({ 
  ...
  const variants = {
    ...
    high: "bg-gradient-to-r from-accent-100 to-accent-200 text-accent-800 shadow-sm",
    medium: "bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800 shadow-sm",
    low: "bg-gradient-to-r from-green-100 to-green-200 text-green-800 shadow-sm"
  };
